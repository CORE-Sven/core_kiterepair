...
export default function Page() {
    ...
    return (
        <div className="font-sans text-gray-900 bg-white" data-oid="hd0z-zt">
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <div
                                    className="relative z-20 p-8 h-full flex flex-col rounded-none bg-none"
                                    data-oid="d.lbhce"
                                    key="olk-C_Gv"
                                >
                                    {/* Dekorative Elemente */}
                                    ...
                                    >
                                        ...
                                        >
                                            <div
                                                className="aspect-w-16 aspect-h-9 h-[400px] w-full"
                                                data-oid=".5.6zoq"
                                                key="olk-3R5V"
                                            >
                                                <iframe
                                            ...
                                            <div
                                                ...
                                                key="olk-w9l7"
                                            >
                                                <p className="text-xl" data-oid="r0wfnat">
                                    ...
                                    <div
                                        ...
                                        key="olk-uZ-k"
                                    >
                                        <p className="text-xl mb-4 text-white" data-oid="7wk_39j">
            ...
            {/* 4. Location Section */}
            <section id="location" className="py-24 bg-gray-100" data-oid="cev:az7"></section>
